...
base_url = requests.get('https://house-price-predictor-9ux0.onrender.com/get_locations')
...
if st.button("Predict Price"):
    if main_location is None:
        ...
        with st.spinner():
            json_response = requests.post('https://house-price-predictor-9ux0.onrender.com/predict_home_price', json=inpud_data)
